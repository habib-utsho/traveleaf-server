...
const insertPost = (file, user, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const post = yield post_model_1.default.create(Object.assign(Object.assign({}, payload), { author: existAuthor._id, authorType: `${(_b = (_a = existAuthorUser.role) === null || _a === void 0 ? void 0 : _a.charAt(0)) === null || _b === void 0 ? void 0 : _b.toUpperCase()}${(_c = existAuthorUser.role) === null || _c === void 0 ? void 0 : _c.slice(1)}` }));
    return post;
});
const getAllPosts = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const postQuery = new QueryBuilder_1.default(post_model_1.default.find(), Object.assign(Object.assign({}, query), { sort: `${query.sort}` }))
...
const getPostById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const post = yield post_model_1.default.findById(id).select('-__v');
    if (!post) {
